...
@NamedQueries({
    @NamedQuery(name="findUserApplyById", query="SELECT d FROM UserApply d where d.applyId=:uid"),
    @NamedQuery(name="findUserApplys", query="SELECT d FROM UserApply d")
    })
public class UserApply extends TableEntity implements Serializable {
