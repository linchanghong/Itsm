 ...
 */
@Entity
@SequenceGenerator(name = "GEN_FLOWNODEINSTENCENEW", sequenceName = "SEQ_FLOW", allocationSize=1)
@Table(name="FLOWNODEINSTENCE_NEW",schema="ITSM")
public class FlowNodeInstenceNew extends TableEntity implements java.io.Serializable {
    ...
    // Property accessors
    @Id 
    @GeneratedValue(generator = "GEN_FLOWNODEINSTENCENEW", strategy = GenerationType.SEQUENCE)
